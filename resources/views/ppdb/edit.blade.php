            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <label for="no_pendaftaran" class="fw-bold"><i class="fas fa-file-alt me-2"></i>No. Pendaftaran</label>
                        <input type="text" class="form-control" value="{{ $ppdb->no_pendaftaran }}" readonly>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="tgl_daftar" class="fw-bold"><i class="fas fa-calendar-alt me-2"></i>Tanggal Pendaftaran</label>
                        <input type="text" class="form-control" value="{{ $ppdb->created_at->format('d/m/Y') }}" readonly>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" class="form-control" id="nik_siswa" name="nik_siswa" value="{{ $ppdb->nik_siswa }}">
                    </div>
                    <div class="col-md-4 mb-2">
                        <label for="nama_siswa" class="form-label">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" required value="{{ $ppdb->nama_siswa }}">
                    </div>
                    <div class="col-md-4 mb-2">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="number" class="form-control" id="anak_ke" name="anak_ke" min="1" value="{{ $ppdb->anak_ke }}">
                    </div>
                    <div class="col-md-4 mb-2">
                        <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                        <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="{{ $ppdb->tempat_lahir }}">
                    </div>
                    <div class="col-md-4 mb-2">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" name="hp_siswa" id="hp_siswa" class="form-control" value="{{ $ppdb->hp_siswa }}">
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" name="kode_pos" id="kode_pos" class="form-control" value="{{ $ppdb->kode_pos }}">
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="hp_ortu" id="hp_ortu" class="form-control" value="{{ $ppdb->hp_ortu }}">
                    </div>

                    <h6>Data Ayah</h6>
                    <div class="col-md-6 mb-2">
                        <label for="nik_ayah">NIK Ayah</label>
                        <input type="text" name="nik_ayah" id="nik_ayah" class="form-control" value="{{ $ppdb->nik_ayah }}">
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="nama_ayah">Nama Ayah</label>
                        <input type="text" name="nama_ayah" id="nama_ayah" class="form-control" value="{{ $ppdb->nama_ayah }}">
                    </div>
                    <div class="col-md-6 mb-2">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="pekerjaan_ayah" id="pekerjaan_ayah" class="form-control" value="{{ $ppdb->pekerjaan_ayah }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="nama_ibu" id="nama_ibu" class="form-control" value="{{ $ppdb->nama_ibu }}">
                    </div>
                    <div class="col-md-6 mb-2">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" class="form-control" value="{{ $ppdb->pekerjaan_ibu }}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="text" name="alamat_sekolah" id="alamat_sekolah" class="form-control" value="{{ $ppdb->alamat_sekolah }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <select name="petugas_id" id="petugas_id" class="form-control">
                            ...
                            <option value="{{ $item->id }}" {{ $ppdb->petugas_id == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
